...
const Exercise1Component: React.FC<ExerciseProps> = (props:any) => {
    const goBack = () => {
        props.history.push('./calendar')
    }
    const mapExercises = () => {

    return props.calendar.calendar[1].exerciseArr.map((exercise: exercise) => {
      return (
        <div>
...
export default connect(mapStateToProps)(Exercise1Component);