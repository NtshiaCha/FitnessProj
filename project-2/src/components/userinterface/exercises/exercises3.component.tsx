...
const Exercise3Component: React.FC<ExerciseProps> = (props:any) => {
    const goBack = () => {
        props.history.push('./calendar')
    }
    const mapExercises = () => {

    return props.calendar.calendar[3].exerciseArr.map((exercise: exercise) => {
      return (
        <div>
...
export default connect(mapStateToProps)(Exercise3Component);