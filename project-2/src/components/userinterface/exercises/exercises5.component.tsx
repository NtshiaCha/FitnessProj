...
const Exercise5Component: React.FC<ExerciseProps> = (props:any) => {
    const goBack = () => {
        props.history.push('./calendar')
    }
    const mapExercises = () => {

    return props.calendar.calendar[5].exerciseArr.map((exercise: exercise) => {
      return (
        <div>
...
export default connect(mapStateToProps)(Exercise5Component);